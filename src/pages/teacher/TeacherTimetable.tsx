...
const TeacherTimetable = () => {
    ...
    const handleExportPDF = () => {
        ...
        doc.setFontSize(16);
        doc.setTextColor(40);
        doc.text("My Teaching Schedule", pageWidth / 2, 15, { align: 'center' });
        ...
        const tableBody = times.map(time => {
            ...
            days.forEach(day => {
                ...
                if (slot) {
                    ...
                    if (slot.Class?.name) parts.push(slot.Class.name);
        ...
        doc.save("teaching_schedule.pdf");
    };
    ...
    if (loading) {
        return (
            <DashboardLayout sidebar={sidebarContent} title="My Schedule">
